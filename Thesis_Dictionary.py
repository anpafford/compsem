...
eating_dict = {
    ...
    "truth_value_answer_1": False, # recoded
    "truth_value_query_2": "there is no more salad on the plate",
    "truth_value_answer_2": True, # recoded
...
going_dict = {
    ...
    "continuation_coherent_keyword_1": "inside the house.", # fixed
    "continuation_coherent_suffix_1": "",
    "continuation_incoherent_keyword_1": "outside the house.", # fixed
    "continuation_incoherent_suffix_1": "",
...
gravity_dict = {
    ...
    "truth_value_query_1": "They all fall at different times", # exclude
    "truth_value_answer_1": True,
    "truth_value_query_2": "They all fall to the floor at the same time", # exclude this item 
    "truth_value_answer_2": False,
...
empty_dict = {
    ...
    "continuation_incoherent_keyword_1": "", # removed the word "to"
    "continuation_incoherent_suffix_1": "",
...
shadow_dict = {
    ...
    "truth_value_answer_1": True,
    "truth_value_query_2": "The plant cast a light on the wall",
    "truth_value_answer_2": False,
...
carrying_dict = {
    ...
    "truth_value_answer_1": False, # recode
    "truth_value_query_2": "You are carrying something",
    "truth_value_answer_2": True, # recode
...
smallest_dict = {
    ...
    "truth_value_answer_2": False,
    "continuation_prompt_1": "Next, you look back at the smaller item in the box / larger item in the box.", # exclude
...
correspondence_dict={
    ...
    "truth_value_query_1":"The chest is now unlocked", # wrong reference (exclude)
    "truth_value_answer_1":True,
    "truth_value_query_2":"The chest is now locked", # wrong reference (exclude)
    "truth_value_answer_2":False,
    "continuation_prompt_1":"Next, you",
...
continuation3_dict={
    ...
    "continuation_incoherent_suffix_2":"",
    "continuation_prompt_3":"Next, you take",
    "continuation_coherent_keyword_3":"nothing from the safe.",
    "continuation_coherent_suffix_3":"",
