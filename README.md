...
6) means_regression_analysis.R: vaguely named, this is used for data analysis in llm and human data
7) lookup table, and
8) parsing: needed if you want to run more human experiments, this is what makes it easier to score the results from Qualtrics
